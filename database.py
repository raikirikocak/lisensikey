...
def validate_key():
    ...
    input_key = data.get("key")  # Mengambil nilai 'key' dari JSON
    input_username = data.get("username")  # Mengambil nilai 'username' dari JSON
    ...
    # Periksa apakah key yang diminta ada dalam data
    keys_data = load_keys()
    if input_key in keys_data:
        ...
        # Periksa aktivitas terakhir berdasarkan waktu terakhir request
